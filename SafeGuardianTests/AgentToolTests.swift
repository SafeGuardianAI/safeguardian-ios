...
struct ModelDownloadManagerTests {
    @Test func patternSizeEstimates() {
        let mgr = ModelDownloadManager.shared
        #expect(mgr.patternEstimate(modelID: "mlx-community/Qwen2.5-0.5B-Instruct-4bit") == 350_000_000)
        #expect(mgr.patternEstimate(modelID: "mlx-community/Qwen2.5-3B-Instruct-4bit") == 1_900_000_000)
        #expect(mgr.patternEstimate(modelID: "mlx-community/Llama-3-8B-4bit") == 5_000_000_000)
    }
